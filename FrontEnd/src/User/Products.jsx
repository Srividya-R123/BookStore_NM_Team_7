  ...
  const addToWishlist = async (itemId) => {
    try {
      ...
      const selectedItem = items.find((item) => {
        ...
        return item._id.toString() === itemId.toString();  // Use toString() for comparison
      });
      ...
      // Destructure the needed properties from selectedItem
      const { title, itemImage, _id: itemId2, author, genre, price, description } = selectedItem;
      ...
      console.log('Adding to wishlist with:', { itemId2, title, itemImage, userId, userName, author, genre, price, description });
